...
import android.database.sqlite.SQLiteOpenHelper;
		...
		public class DatabaseHandler_joe extends SQLiteOpenHelper {
		    ...
		    // Database Name
		    private static final String DATABASE_NAME = "timetablerN5.db";
		 ...
		 // Login table name
			...
			/**   // All Static variables
			   ...
			   // Database Name
			   private static final String DATABASE_NAME = "school2";
		 ...
		 /**
		    ...
		    */
		    ...
		    public DatabaseHandler_joe(Context context) {
		  ...
		  /**/  public HashMap<String, String> getUserDetails(){
		    ...
		    public void addUser(String fname, String lname, String email, String password, String uid, String inst_id, String school_id, String date_joined, String learningDays, String startTime, String endTime, String duration) {
		        ...
		        values.put("reg_no", cursor.getString(2));
		        values.put("uid", cursor.getString(3));
		        values.put("created_at", cursor.getString(4));
		     ...
		     * Storing user details in database
		     * */
		    public void addUserUniDetails(String year, String userId) {
		        SQLiteDatabase db = this.getWritableDatabase();
		        /*
		        ContentValues scValues = new ContentValues();
		        scValues.put("yearId", yearId);*/
		        ContentValues values = new ContentValues();
