...
import com.br.timetabler.widget.CommentsListView;
			...
			public class SingleAssignmentActivity extends ActionBarActivity implements CommentClickListener {
				...
				protected void onCreate(Bundle savedInstanceState) {
					...
					txtDateDue.setText("Date Due "+dateDue);
				...
				public boolean onOptionsItemSelected(MenuItem item) {
			        switch (item.getItemId()) {
			            ...
			            case R.id.menu_list: //display description
			            	Intent i2 = new Intent(getApplicationContext(), NotesListActivity.class);
			    ...
			    public void getCommentsFeed(View v){
			        ...
			        new Thread(new GetCommentsTask(responseHandler,null,null, unit_id, false, null)).start();
			    }
