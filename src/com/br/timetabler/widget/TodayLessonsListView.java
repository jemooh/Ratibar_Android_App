...
public class TodayLessonsListView extends ListView implements android.widget.AdapterView.OnItemClickListener {
	...
	public TodayLessonsListView(Context context) {
        super(context);
    }
	
	public TodayLessonsListView(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
    }
 
    public TodayLessonsListView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
    ...
    public void setLessons(List<Lesson> lessons){
    	...
    	TodayLessonsAdapter adapter = new TodayLessonsAdapter(getContext(), lessons);
        setAdapter(adapter);
